...
func (c *notificationServiceClient) SendEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/communication.NotificationService/SendEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) SendPushNotification(ctx context.Context, in *PushNotificationRequest, opts ...grpc.CallOption) (*PushNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/communication.NotificationService/SendPushNotification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/communication.NotificationService/SendEmail",
	}
...
func _NotificationService_SendPushNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/communication.NotificationService/SendPushNotification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/communication/notification.proto",
}
